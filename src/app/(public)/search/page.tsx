        ...
        <main className='relative flex flex-col'>
            <section className="relative py-10 lg:py-20 px-4 text-center bg-primary shadow-lg shadow-text/10">
                <div className="container mx-auto flex justify-center items-center gap-2">
                    ...
                    <h2 className={`heading-two text-white capitalize font-medium font-aladin max-w-xl`}>&ldquo;{q}&rdquo;</h2>
                    <p className={`text-default leading-none font-play text-light-secondary text-default max-w-xl`}>returned {res?.data?.length} results</p>
                </div>
            </section>
