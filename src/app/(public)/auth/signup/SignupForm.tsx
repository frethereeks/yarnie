    ...
    return (
        <section className='flex-1 flex flex-col justify-center items-center gap-2 min-h-screen'>
            ...
            >
                ...
                <button type="submit" disabled={loading} className="md:col-span-2 rounded-full py-2 px-5 md:px-8 w-full bg-primary shadow-primary shadow-md text-white text-sm text-center flex-1 cursor-pointer flex items-center justify-center gap-2 mt-2">{loading ? <span className=''></span> : <IoFastFoodOutline className="text-sm text-inherit" />} {loading ? 'Processing...' : 'Create Account'}</button>
            </Form>
            {/* </form> */}
