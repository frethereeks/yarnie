      ...
      <section className='bg-primary px-4 relative '>
        ...
        <div className="relative container mx-auto py-10 lg:my-10 lg:px-10 flex flex-col md:flex-row gap-4 lg:justify-center">
          ...
          <aside className="flex-1 relative z-10 flex flex-col justify-center gap-4 py-5 md:py-10 md:px-4">
            <h1 data-aos="fade-up" data-aos-delay="500" data-aos-duration="1500" className="text-5xl md:text-5xl text-white text-center sm:text-justify font-bold font-serif">About <span className="px-1.5 text-primary bg-border flex mx-auto lg:inline sm:mx-0 w-max">The Yarnie</span></h1>
            <p data-aos="fade-up" data-aos-delay="500" data-aos-duration="1500" className="font-montserrat text-white text-base text-center sm:text-justify leading-loose lg:max-w-md">The Yarnie is all about a crochet making, crochet making is the process of creating fabric or other similar items using a crochet hook to interlock loops of yarn, thread, or other materials. It&apos;s a versatile craft that can be used to make a wide variety of items, from clothing and accessories to home décor and toys.</p>
          </aside>
        </div>
      </section>
