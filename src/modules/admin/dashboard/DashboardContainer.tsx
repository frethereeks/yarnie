...
//             <p className="text-xsmall font-play opacity-75">Here you can manage your online store</p>
//           </div>
//           <div style={{ borderTop: "1px solid #ddd", paddingTop: '.45rem' }} className="text-xxsmall font-play flex justify-end gap-4">
//             <p className='flex items-center gap-1 text-xs'><span className="grid h-2 w-2 bg-primary flex-shrink-0"></span> {res?.data?.user?.role === "Owner" ? "MAIN ADMIN" : res?.data?.user?.role}</p>
//           </div>
//         </aside>
...
//                 <p style={{ opacity: .7 }} className="text-xxsmall font-play opacity-75 text-right">Sales</p>
...
//               </div>
//               <div className="flex flex-col items-end">
//                 <p style={{ opacity: .7 }} className="text-xxsmall font-play opacity-75 text-right">Food</p>
...
//               </div>
//               <div className="flex flex-col items-end">
//                 <p style={{ opacity: .7 }} className="text-xxsmall font-play opacity-75 text-right">Staff</p>
